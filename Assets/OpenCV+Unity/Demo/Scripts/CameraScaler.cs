namespace OpenCvSharp.Demo
{
	...
	public class CameraScaler : MonoBehaviour {
		...
		void Scale() {
            ...
            if (AppManager.instance.currentScene==ActivityScene.Caregiver_UploadImage_Scene)
			    this.transform.localScale = new Vector3 (aspect*0.7f, aspect*0.6f, 1.0f);
            else if (AppManager.instance.currentScene == ActivityScene.WhoAreYouScene)
                this.transform.localScale = new Vector3(aspect*0.9f, aspect * 0.9f, 1.0f);
